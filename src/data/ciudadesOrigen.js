export const ciudadesOrigen = [
  ...
  { label: "TARAPOTO", value: "Jiron Gregorio Delgado 344 - Tarapoto" },
  { label: "PUERTO MALDONADO", value: "Av. Dos de Mayo - Puerto Maldonado" },
  { label: "AREQUIPA", value: "Av. San Martin 409 - Arequipa" },
  {
    label: "CHICLAYO",
